<?php
	...
	function hitung_tagihan_awal($harga, $jumlah){
		...
		return $tagihan_awal;
		//Kode ini untuk mengembalikan nilai tagihan awal berdasarkan harga dan jumlah
	}

	//	Instruksi Kerja Nomor 2.
	//	Variabel lokasi berisi data kota lokasi restoran dalam bentuk array.
	$lokasi = array("Jakarta", "Bogor", "Depok", "Tanggerang", "Bekasi");
	//	Instruksi Kerja Nomor 3.
	//	Mengurutkan array lokasi sesuai abjad A-Z.
	array_multisort($lokasi, SORT_ASC);
...
<html>
	...
	<?php
		...
		if(isset($_POST['Pesan'])) {
			...
			if ($dataPesanan['lokasi'] == "Tanggerang") {
				$ongkir = 5000;
			} 
